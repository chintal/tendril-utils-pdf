...
setup(
    name='tendril-utils-pdf',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="PDF utilities for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-pdf',
    project_urls={
        'Documentation': 'https://tendril-utils-pdf.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-pdf/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-pdf',
    },
